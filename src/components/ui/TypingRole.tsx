...
export function TypingRole({ onFinish }: { onFinish?: () => void }) {
  ...
  <span className="left-0 top-0 invisible text-black text-[clamp(1rem,2vw,1.2rem)] font-medium">
    A growth-focused senior software engineer
    <span className="ml-1 animate-[blink_1s_infinite]">|</span>
  </span>
        {/* Typed text */}
        <div className="absolute left-0 top-0 text-black text-[clamp(1rem,2vw,1.2rem)] font-medium">
          {displayed}
          <span className="ml-1 animate-[blink_1s_infinite]">|</span>
        </div>
        </div>
