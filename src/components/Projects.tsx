...
const projects: Project[] = [
    ...
    },
    {
        ...
        image: 'VWOS-alt.png',
        about: 'Worked on component testing for Volkswagen’s VW.OS, a Linux-based automotive operating system, focusing on requirement-based test design, automation, and continuous integration across multiple product clusters.',
        technologies: [
            'Robot Framework',
            'Ubuntu',
            'CI/CD',
    ...
    },
    {
        ...
        image: 'OTIS-alt.png',
        about: 'Developed an end-to-end Hardware-in-the-Loop (HiL) test automation system for elevator control, replacing manual Excel-based testing with a fully integrated and automated workflow across Simulink, CANoe, and embedded hardware.',
        technologies: [
            'Python',
            'MATLAB/Simulink',
            'CAPL',
    ...
    },
    {
        ...
        about: 'Designed a prototype application for an RFID-based automotive connector system, visualizing vehicle structure and highlighting faulty components through an intuitive user interface.',
    ...
    },
    {
        ...
        about: 'Designed and implemented a communication solution for Smart Grid systems by integrating IEC 61850 with XMPP, extending an open-source C library to enable scalable, secure, and flexible machine-to-machine communication.',
    ...
    },
    {
        ...
        image: 'NXP-alt.png',
        about: 'Developed a vision-based autonomous navigation system for a model car in the NXP Intelligent Car Competition, using image data and embedded processing on an ARM-based microcontroller.',
...
export function Projects() {
    ...
    return (
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                {/* <div className="flex flex-col w-full"> */}
                                <button className="mt-auto self-end mcolor-txt text-[8px] md:text-xs hover:underline cursor-pointer">
                                    View Details
                                </button>
                            </div>
                            {/* </div> */}
        ...
        shadow-lg top-0 ml-auto block text-gray-400 hover:text-white z-10"
                        ...
                        <h3 className="sec-txt mb-4">{selectedProject.title}</h3>

                        <p className="text-sm md:text-base mb-6">{selectedProject.about}</p>

                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-1 h-6 bg-blue-400 rounded"></div>
                            <div className="trd-txt">About this project</div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 mb-3">
                            <div className="w-1 h-6 bg-blue-400 rounded"></div>
                            <div className="trd-txt font-semibold">Technologies & Tools</div>
                        </div>
